...
btx_uuid_t Market::buy_limit(const std::string &market, const float &quantity, const float &rate) {
    auto res = api_request<btx_uuid_t, btx_uuid_t>(BUYLIMIT_END_P, bittrex::api::Type::MARKET, "market=", market, "quantity=",
                                           quantity,
                                           "rate=", rate);
    return res;
}
...
btx_uuid_t Market::sell_limit(const std::string &market, const float &quantity, const float &rate) {
    ...
    auto res = api_request<btx_uuid_t, btx_uuid_t>(SELLLIMIT_END_P, bittrex::api::Type::MARKET, "market=", market, "quantity=",
                                           quantity,
                                           "rate=", rate);
    return res;
...
btx_uuid_t Market::cancel(const std::string &uuid) {
    auto res = api_request<btx_uuid_t, btx_uuid_t>(CANCEL_END_P, bittrex::api::Type::MARKET, "uuid=", uuid);
    return res;
}
